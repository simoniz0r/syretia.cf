...
def weilbyte [voice text] {
    ...
    let base64 = try { http post -m 6 -H [content-type application/json] https://tiktok-tts.weilbyte.dev/api/generate $body | encode base64 } catch { return (lazypy $voice "TikTok" $text) }
